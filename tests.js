...
describe('add', function () {
    ...
    it('should return 5 when called with add(2, 3)', function () {
        expect(add(2, 3)).toBe(5);
    });
    it('should return -12 when called with add(-3, -9)', function () {
        expect(add(-3, -9)).toBe(-12);
    });
    it('should return 11 when called with add("5", 6)', function () {
        expect(add("5", 6)).toBe(11);
    });
    it('should return 6 when called with add("-4", "10")', function () {
        expect(add("-4", "10")).toBe(6);
    });
    it('should return NaN when called with add("banana", "split")', function () {
        expect(add("banana", "split")).toBeNaN();
    });
    it('should return NaN when called with add(2, "apples")', function () {
